...
namespace GUI.FormEdelivery
{
    public partial class FrmKeHoachGiaoNhanTongHop : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            var viewKeHoach = new DataTable();
            viewKeHoach.Columns.Add("stt", typeof(int));
            viewKeHoach.Columns.Add("MaKhachHang",typeof(string));
            viewKeHoach.Columns.Add("TenKhachHang", typeof(string));
            viewKeHoach.Columns.Add("DonViVanChuyen", typeof(string));
            viewKeHoach.Columns.Add("NgayGiaoNhan", typeof(string));
            viewKeHoach.Columns.Add("SONumber", typeof(string));
            viewKeHoach.Columns.Add("SOItems", typeof(string));
            viewKeHoach.Columns.Add("TenNoiGiaoNhan", typeof(string));
            viewKeHoach.Columns.Add("BienSo_SoHieu", typeof(string));
            viewKeHoach.Columns.Add("RoMooc", typeof(string));
            viewKeHoach.Columns.Add("TaiXe_ThuyenTruong", typeof(string));
            viewKeHoach.Columns.Add("CMND_CCCD", typeof(string));
            viewKeHoach.Columns.Add("MaHangHoa", typeof(string));
            viewKeHoach.Columns.Add("TenHangHoa", typeof(string));
            viewKeHoach.Columns.Add("SOBC", typeof(int));
            viewKeHoach.Columns.Add("SOCAY", typeof(int));
            viewKeHoach.Columns.Add("SOCAYLE", typeof(int));
            viewKeHoach.Columns.Add("SOLUONGBEBO", typeof(int));
            viewKeHoach.Columns.Add("TRONGLUONG", typeof(decimal));

            var lst = dKEdeliveryDAO.GetAllKeHoachTongHop(searchEdelivery());
            int i = 1;
            foreach (var item in lst.ToList())
            {
                viewKeHoach.Rows.Add(i++,item.MaKhachHang,
                item.TenKhachHang, item.DonViVanChuyen, item.NgayGiaoNhan.ToString(),
                item.SONumber,item.SOItems,item.TenNoiGiaoNhan,item.BienSo_SoHieu,item.RoMooc,
                item.TaiXe_ThuyenTruong,item.CMND_CCCD,item.MaHangHoa,item.TenHangHoa,item.SOBC,
                item.SOCAY,item.SOCAYLE,item.SOLUONGBEBO,item.TRONGLUONG);
            }
            viewKeHoach.TableName = "ViewKeHoachDetail";


            var info = new DataTable();
            info.Columns.Add("donvi");
            info.Columns.Add("tenkh");
            info.Columns.Add("noigiaonhan");
            info.Columns.Add("madonhang");
            info.Columns.Add("ngaygiaonhan");
            info.Columns.Add("trangthai");
            ...
            info.TableName = "info";
            var ds = new DataSet();
            ds.Tables.Add(viewKeHoach);
            ds.Tables.Add(info);

            string NameFile = "invoice" + DateTime.Now.Ticks + ".xlsx";

            ExportKeHoachGiaoNhan.FillReport(NameFile, "template.xlsx", ds, new string[] { "{", "}" });
